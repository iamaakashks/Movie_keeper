        ...
        <div className="w-full h-screen">
            <div className="pb-[2%]">
                <form className="relative w-[50%] m-auto">
                    <input className="w-full text-black placeholder:text-black bg-transparent border-[1px] border-slate-700 rounded-full pl-3 pr-16 py-1.5 outline-none" type="search" placeholder="Search Movies" />
